<%-- 
    Document   : index
    Created on : Jun 13, 2020, 8:45:36 PM
    Author     : hieule
--%>
    ...
    <head>
        ...
        <style>
            body {
                ...
                background-size: 1500px 1500px, 410px 410px, 610px 610px, 530px 530px, 730px 730px, 1000px 1000px;
                background-color: #840b2a;
            }
    ...
    <body>
        <section class="login">
            ...
            <form action="login" method="post">
                <input type="text" id="username" name="username" required title="Username required" placeholder="Username" data-icon="U">
                <input type="password" id="password" name="password" required title="Password required" placeholder="Password" data-icon="x">
                <div class="olvido">
            ...
            <div><font color="red">${requestScope.notify}</font></div>
        </section>
